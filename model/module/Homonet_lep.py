...
class SwinTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        _, _, h_x, w_x, = x1_fea.shape

        x1_fea = x1_fea.flatten(2).transpose(1, 2)
        x2_fea = x2_fea.flatten(2).transpose(1, 2)
...
class BasicCrossLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, layer_depth, num_heads, window_size,
        ...
        for l in range(layer_depth):
            ...
            dim_current = dim * 2 ** l
            blocks_list = [SwinCrossBlock(dim=dim_current, input_resolution=input_resolution_current,
